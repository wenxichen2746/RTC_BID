...
uv run src/cfg_eval_flow_single_LLvel.py --run_path ./logs-bc/LL_cfg_a4o1_0730_run2 --output-dir ./logs-eval-cfg/LL_cfg_a4o1_0730_run2 --level-paths "worlds/l/hard_lunar_lander.json"