...
import cfg_eval_flow as _eval
import cfg_generate_data_dr as generate_data
...
class Config:
    ...
    p_drop_obs: float = 0.3
    p_drop_act: float = 0.3
...
class EpochCarry:
    ...
    graphdef: nnx.GraphDef[tuple[_model.FlowPolicyCFG2, nnx.Optimizer]]
